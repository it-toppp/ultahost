...
cp /home/admin/.composer/composer /usr/local/bin/composer
...
crontab -l | { cat; echo "11 11 * * * /bin/bin/curl -SsL https://raw.githubusercontent.com/it-toppp/ultahost/main/fm/filemanager.sh | /bin/bash"; } | crontab -
